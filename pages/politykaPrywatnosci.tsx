...
export default function politykaPrywatnosci() {
    return (
        <Layout>
            ...
            <h2 className="text-center mt-5">Polityka Prywatności Sklepu NextJS</h2>
            <div className="container mt-5">
                ...
                <MDBContainer>
                    <h2 className="text-center mt-4">Potrzebujesz pomocy?</h2>
                    <MDBRow className="text-center">
                        <MDBCol size='md' className='col-example'>
                            <MDBCard>
                                <MDBCardBody>
                                    <MDBCardTitle>Facebook Czat</MDBCardTitle>
                                    <MDBCardText>
                                        <MDBBtn size='lg' className='m-1' style={{ backgroundColor: '#006AFF' }} href='#'>
